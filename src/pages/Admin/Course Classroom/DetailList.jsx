...
export default function CourseClassList({ setLoading }) {
    ...
    const handleDelete = async (courseClassId) => {
        try {
            await axios.delete(`http://localhost:5148/api/course-classroom/${courseClassId}`)
        ...
        const fetchData = async () => {
            ...
            try {
                const { data: course } = await axios.get(
                    `http://localhost:5148/api/course/${courseId}`
                )
                const { data: courseClasses } = await axios.get(
                    `http://localhost:5148/api/course-classroom/course/${courseId}`
                )
