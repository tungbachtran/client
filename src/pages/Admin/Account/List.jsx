...
export default function UserList({ setLoading }) {
    ...
    const handleSelectFaculty = (data) => {
        ...
        if (data.facultyId === 0) {
            let temp = []
            axios
                .get(`https://192.168.1.7:5001/api/classroom`)
                .then((res) => {
                    temp = res.data
    ...
    const handleSelectClass = (data) => {
        ...
        if (data.id === 0) {
            axios
                .get(`https://192.168.1.7:5001/api/user/faculty/${data.faculty}`)
                .then((res) => {
                    let tempData = []
        ...
        axios
            .get(`https://192.168.1.7:5001/api/user/class/${data.id}`)
            .then((res) => {
                let tempData = []
    ...
    const handleDeleteUser = (id) => {
        axios
            .delete(`https://192.168.1.7:5001/api/user/${id}`)
            .then(() => {
