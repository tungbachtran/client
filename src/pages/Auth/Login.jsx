...
export default function Login({ setLoading }) {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true)
        try {
            const { data: jwt } = await axios.post('https://10.10.36.197:5001/api/account/login', {
                username: username,
                password: pwd
            })
        ...
        <div
            ...
            <form
                ...
                {/* <Link
                    ...
                    className="flex forgot-password mt-2 text-sm font-semibold self-end translate-x-4">
                    Quên mật khẩu?
                    <BsArrowRight />
                </Link> */}
